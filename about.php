...
<div style="margin-left: 0;"class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<strong><h1 style="text-align:center"><b>About Us</b></h1></strong>
			<p style="position: relative;float: left;width: 850px;">Hotel unveils a celebrated balance of nostalgia and contemporary style, capturing its original Southern elegance, luxury, and decadence. Machuca tiles form cool geometric patterns in the hallways. Hotel hardwood floors contrast modern furnishings and amenities in the dramatic suites.The Hotel lifestyle offers guests the finest sensory indulgences: soothing organic toiletries, heirloom recipes, and unmatched privacy and tranquility</p>
			<img style = "float:right;" src = "images/about.jpg" width = "250px" height = "250px" />
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Small Size Bed</label><label style = "color:red;">INR. 800.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>1 Medium Size Bed</label> <label style = "color:red;">INR. 2,400.00 </label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>2 Medium Size Bed</label> <label style = "color:red;">INR. 2,800.00 </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style = "color:red;">INR. 3,800.00 </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style = "color:red;">INR. 4,000.00 </label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<br />
				<strong><h1 style="text-align:center"><b>Amenities & Services In Hotel</b></h1></strong>
				<ul style="color: red;">
